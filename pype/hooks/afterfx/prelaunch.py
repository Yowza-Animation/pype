...
from pype.hosts.afterfx import lib as prlib


class AfterFXPrelaunch(PypeHook):
    """
    This hook will check if current workfile path has Adobe AfterFX
